...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='Y:\\Projects\\Spinco\\SINEEG\\Scripts\\Experiments\\SiN\\Experiment2\\SiN_task\\SIN_lab_27-06-23_lastrun.py',
...
def setupDevices(expInfo, thisExp, win):
    ...
    # create speaker 'sound_examples'
    deviceManager.addDevice(
        deviceName='sound_examples',
        deviceClass='psychopy.hardware.speaker.SpeakerDevice',
        index=-1
    )
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    sound_examples = sound.Sound(
        'A', 
        secs=-1, 
        stereo=True, 
        hamming=True, 
        speaker='sound_examples',    name='sound_examples'
    )
    ...
    trials_eg = data.TrialHandler(nReps=0.0, method='sequential', 
    ...
    for thisTrials_eg in trials_eg:
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('audioTrial_eg.started', globalClock.getTime(format='float'))
        ...
        while continueRoutine:
            ...
            if screenAfterAudio_2.status == STARTED:
                ...
                if tThisFlip > 1-frameTolerance:
                    ...
                    screenAfterAudio_2.tStopRefresh = tThisFlipGlobal  # on global time
        ...
        for thisComponent in audioTrial_egComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('audioTrial_eg.stopped', globalClock.getTime(format='float'))
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('trial_eg.started', globalClock.getTime(format='float'))
        ...
        while continueRoutine:
            ...
            if blankScreen_2.status == STARTED:
                ...
                if tThisFlipGlobal > blankScreen_2.tStartRefresh + 1.0-frameTolerance:
                    ...
                    blankScreen_2.tStopRefresh = tThisFlipGlobal  # on global time
            ...
            if call1_2.status == STARTED:
                if bool(blankScreenAfterResponse_2.status == STARTED):
                    ...
                    call1_2.tStopRefresh = tThisFlipGlobal  # on global time
            ...
            if call2_2.status == STARTED:
                if bool(blankScreenAfterResponse_2.status == STARTED):
                    ...
                    call2_2.tStopRefresh = tThisFlipGlobal  # on global time
            ...
            if call3_2.status == STARTED:
                if bool(blankScreenAfterResponse_2.status == STARTED):
                    ...
                    call3_2.tStopRefresh = tThisFlipGlobal  # on global time
            ...
            if call4_2.status == STARTED:
                if bool(blankScreenAfterResponse_2.status == STARTED):
                    ...
                    call4_2.tStopRefresh = tThisFlipGlobal  # on global time
            ...
            if colour1_2.status == STARTED:
                if bool(blankScreenAfterResponse_2.status == STARTED):
                    ...
                    colour1_2.tStopRefresh = tThisFlipGlobal  # on global time
            ...
            if colour2_2.status == STARTED:
                if bool(blankScreenAfterResponse_2.status == STARTED):
                    ...
                    colour2_2.tStopRefresh = tThisFlipGlobal  # on global time
            ...
            if colour3_2.status == STARTED:
                if bool(blankScreenAfterResponse_2.status == STARTED):
                    ...
                    colour3_2.tStopRefresh = tThisFlipGlobal  # on global time
            ...
            if colour4_2.status == STARTED:
                if bool(blankScreenAfterResponse_2.status == STARTED):
                    ...
                    colour4_2.tStopRefresh = tThisFlipGlobal  # on global time
            ...
            if number1_2.status == STARTED:
                if bool(blankScreenAfterResponse_2.status == STARTED):
                    ...
                    number1_2.tStopRefresh = tThisFlipGlobal  # on global time
            ...
            if number2_2.status == STARTED:
                if bool(blankScreenAfterResponse_2.status == STARTED):
                    ...
                    number2_2.tStopRefresh = tThisFlipGlobal  # on global time
            ...
            if number3_2.status == STARTED:
                if bool(blankScreenAfterResponse_2.status == STARTED):
                    ...
                    number3_2.tStopRefresh = tThisFlipGlobal  # on global time
            ...
            if number4_2.status == STARTED:
                if bool(blankScreenAfterResponse_2.status == STARTED):
                    ...
                    number4_2.tStopRefresh = tThisFlipGlobal  # on global time
            ...
            if blankScreenAfterResponse_2.status == STARTED:
                ...
                if tThisFlipGlobal > blankScreenAfterResponse_2.tStartRefresh + 0.3-frameTolerance:
                    ...
                    blankScreenAfterResponse_2.tStopRefresh = tThisFlipGlobal  # on global time
        ...
        for thisComponent in trial_egComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('trial_eg.stopped', globalClock.getTime(format='float'))
    ...
    # completed 0.0 repeats of 'trials_eg'
