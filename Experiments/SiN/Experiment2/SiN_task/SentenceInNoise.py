...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='Y:\\Projects\\Spinco\\SINEEG\\Scripts\\Experiments\\SiN\\Experiment2\\SiN_task\\SentenceInNoise.py',
...
def setupWindow(expInfo=None, win=None):
    ...
    if win is None:
        ...
        win = visual.Window(
            size=[1280, 1024], fullscr=_fullScr, screen=1,
