...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Gorka\\Desktop\\SiN_LAB\\SIN_lab_01-06-23_lastrun.py',
...
instrRest_POSTClock = core.Clock()
...
restTrial_postClock = core.Clock()
...
instrStartClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1
...
while continueRoutine:
    ...
    tThisFlip = win.getFutureFlipTime(clock=instrStartClock)
...
thisExp.addData('instr_start.started', instr_start.tStartRefresh)
thisExp.addData('instr_start.stopped', instr_start.tStopRefresh)
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
instrRest_PREClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1

# -------Run Routine "instrRest_PRE"-------
while continueRoutine:
    # get current time
    t = instrRest_PREClock.getTime()
    tThisFlip = win.getFutureFlipTime(clock=instrRest_PREClock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
    ...
    if pp_instrRest_PRE.status == STARTED:
        ...
        if tThisFlipGlobal > pp_instrRest_PRE.tStartRefresh + 0.01-frameTolerance:
            ...
            win.timeOnFlip(pp_instrRest_PRE, 'tStopRefresh')  # time at next scr refresh
...
for thisComponent in instrRest_PREComponents:
    if hasattr(thisComponent, "setAutoDraw"):
        thisComponent.setAutoDraw(False)
thisExp.addData('instrRest_pre.started', instrRest_pre.tStartRefresh)
thisExp.addData('instrRest_pre.stopped', instrRest_pre.tStopRefresh)
if pp_instrRest_PRE.status == STARTED:
    win.callOnFlip(pp_instrRest_PRE.setData, int(0))
thisExp.addData('pp_instrRest_PRE.started', pp_instrRest_PRE.tStartRefresh)
thisExp.addData('pp_instrRest_PRE.stopped', pp_instrRest_PRE.tStopRefresh)
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
restTrial_preClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1

# -------Run Routine "restTrial_pre"-------
while continueRoutine:
    # get current time
    t = restTrial_preClock.getTime()
    tThisFlip = win.getFutureFlipTime(clock=restTrial_preClock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
    ...
    if fixation_1.status == STARTED:
        # is it time to stop? (based on global clock, using actual start)
        if tThisFlipGlobal > fixation_1.tStartRefresh + 240-frameTolerance:
            # keep track of stop time/frame for later
    ...
    if screenAfterAudio_3.status == STARTED:
        ...
        if tThisFlip > 2 -frameTolerance:
            ...
            win.timeOnFlip(screenAfterAudio_3, 'tStopRefresh')  # time at next scr refresh
    ...
    if pp_rest_pre_start.status == STARTED:
        ...
        if tThisFlipGlobal > pp_rest_pre_start.tStartRefresh + 0.01-frameTolerance:
            ...
            win.timeOnFlip(pp_rest_pre_start, 'tStopRefresh')  # time at next scr refresh
...
thisExp.addData('screenAfterAudio_3.started', screenAfterAudio_3.tStartRefresh)
thisExp.addData('screenAfterAudio_3.stopped', screenAfterAudio_3.tStopRefresh)
beep_rest_pre_end.stop()  # ensure sound has stopped at end of routine
thisExp.addData('beep_rest_pre_end.started', beep_rest_pre_end.tStartRefresh)
thisExp.addData('beep_rest_pre_end.stopped', beep_rest_pre_end.tStopRefresh)
if pp_rest_pre_start.status == STARTED:
    win.callOnFlip(pp_rest_pre_start.setData, int(0))
thisExp.addData('pp_rest_pre_start.started', pp_rest_pre_start.tStartRefresh)
thisExp.addData('pp_rest_pre_start.stopped', pp_rest_pre_start.tStopRefresh)
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
instrMain_1Clock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1

# -------Run Routine "instrMain_1"-------
while continueRoutine:
    # get current time
    t = instrMain_1Clock.getTime()
    tThisFlip = win.getFutureFlipTime(clock=instrMain_1Clock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
...
for thisComponent in instrMain_1Components:
    if hasattr(thisComponent, "setAutoDraw"):
        thisComponent.setAutoDraw(False)
thisExp.addData('instr_start_1.started', instr_start_1.tStartRefresh)
thisExp.addData('instr_start_1.stopped', instr_start_1.tStopRefresh)
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
instrMain_2Clock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1

# -------Run Routine "instrMain_2"-------
while continueRoutine:
    # get current time
    t = instrMain_2Clock.getTime()
    tThisFlip = win.getFutureFlipTime(clock=instrMain_2Clock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
    ...
    if pp_instr_start_2.status == STARTED:
        ...
        if tThisFlipGlobal > pp_instr_start_2.tStartRefresh + 0.01-frameTolerance:
            ...
            win.timeOnFlip(pp_instr_start_2, 'tStopRefresh')  # time at next scr refresh
...
for thisComponent in instrMain_2Components:
    if hasattr(thisComponent, "setAutoDraw"):
        thisComponent.setAutoDraw(False)
thisExp.addData('instr_start_2.started', instr_start_2.tStartRefresh)
thisExp.addData('instr_start_2.stopped', instr_start_2.tStopRefresh)
if pp_instr_start_2.status == STARTED:
    win.callOnFlip(pp_instr_start_2.setData, int(0))
thisExp.addData('pp_instr_start_2.started', pp_instr_start_2.tStartRefresh)
thisExp.addData('pp_instr_start_2.stopped', pp_instr_start_2.tStopRefresh)
...
for thisTrials_eg in trials_eg:
    ...
    t = 0
    _timeToFirstFrame = win.getFutureFlipTime(clock="now")
    audioTrial_egClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
    frameN = -1
    
    # -------Run Routine "audioTrial_eg"-------
    while continueRoutine:
        # get current time
        t = audioTrial_egClock.getTime()
        tThisFlip = win.getFutureFlipTime(clock=audioTrial_egClock)
        tThisFlipGlobal = win.getFutureFlipTime(clock=None)
        frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
        # update/draw components on each frame
        ...
        if screenAfterAudio_2.status == STARTED:
            ...
            if tThisFlip > 1-frameTolerance:
                ...
                win.timeOnFlip(screenAfterAudio_2, 'tStopRefresh')  # time at next scr refresh
    ...
    trials_eg.addData('sound_examples.started', sound_examples.tStartRefresh)
    trials_eg.addData('sound_examples.stopped', sound_examples.tStopRefresh)
    trials_eg.addData('fixation_2.started', fixation_2.tStartRefresh)
    trials_eg.addData('fixation_2.stopped', fixation_2.tStopRefresh)
    trials_eg.addData('screenAfterAudio_2.started', screenAfterAudio_2.tStartRefresh)
    trials_eg.addData('screenAfterAudio_2.stopped', screenAfterAudio_2.tStopRefresh)
    ...
    t = 0
    _timeToFirstFrame = win.getFutureFlipTime(clock="now")
    trial_egClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
    frameN = -1
    
    # -------Run Routine "trial_eg"-------
    while continueRoutine:
        # get current time
        t = trial_egClock.getTime()
        tThisFlip = win.getFutureFlipTime(clock=trial_egClock)
        tThisFlipGlobal = win.getFutureFlipTime(clock=None)
        frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
        # update/draw components on each frame
        ...
        if blankScreen_2.status == STARTED:
            ...
            if tThisFlipGlobal > blankScreen_2.tStartRefresh + 1.0-frameTolerance:
                ...
                win.timeOnFlip(blankScreen_2, 'tStopRefresh')  # time at next scr refresh
        ...
        if call1_2.status == STARTED:
            if bool(blankScreenAfterResponse_2.status == STARTED):
                ...
                win.timeOnFlip(call1_2, 'tStopRefresh')  # time at next scr refresh
        ...
        if call2_2.status == STARTED:
            if bool(blankScreenAfterResponse_2.status == STARTED):
                ...
                win.timeOnFlip(call2_2, 'tStopRefresh')  # time at next scr refresh
        ...
        if call3_2.status == STARTED:
            if bool(blankScreenAfterResponse_2.status == STARTED):
                ...
                win.timeOnFlip(call3_2, 'tStopRefresh')  # time at next scr refresh
        ...
        if call4_2.status == STARTED:
            if bool(blankScreenAfterResponse_2.status == STARTED):
                ...
                win.timeOnFlip(call4_2, 'tStopRefresh')  # time at next scr refresh
        ...
        if colour1_2.status == STARTED:
            if bool(blankScreenAfterResponse_2.status == STARTED):
                ...
                win.timeOnFlip(colour1_2, 'tStopRefresh')  # time at next scr refresh
        ...
        if colour2_2.status == STARTED:
            if bool(blankScreenAfterResponse_2.status == STARTED):
                ...
                win.timeOnFlip(colour2_2, 'tStopRefresh')  # time at next scr refresh
        ...
        if colour3_2.status == STARTED:
            if bool(blankScreenAfterResponse_2.status == STARTED):
                ...
                win.timeOnFlip(colour3_2, 'tStopRefresh')  # time at next scr refresh
        ...
        if colour4_2.status == STARTED:
            if bool(blankScreenAfterResponse_2.status == STARTED):
                ...
                win.timeOnFlip(colour4_2, 'tStopRefresh')  # time at next scr refresh
        ...
        if number1_2.status == STARTED:
            if bool(blankScreenAfterResponse_2.status == STARTED):
                ...
                win.timeOnFlip(number1_2, 'tStopRefresh')  # time at next scr refresh
        ...
        if number2_2.status == STARTED:
            if bool(blankScreenAfterResponse_2.status == STARTED):
                ...
                win.timeOnFlip(number2_2, 'tStopRefresh')  # time at next scr refresh
        ...
        if number3_2.status == STARTED:
            if bool(blankScreenAfterResponse_2.status == STARTED):
                ...
                win.timeOnFlip(number3_2, 'tStopRefresh')  # time at next scr refresh
        ...
        if number4_2.status == STARTED:
            if bool(blankScreenAfterResponse_2.status == STARTED):
                ...
                win.timeOnFlip(number4_2, 'tStopRefresh')  # time at next scr refresh
        ...
        if blankScreenAfterResponse_2.status == STARTED:
            ...
            if tThisFlipGlobal > blankScreenAfterResponse_2.tStartRefresh + 0.3-frameTolerance:
                ...
                win.timeOnFlip(blankScreenAfterResponse_2, 'tStopRefresh')  # time at next scr refresh
    ...
    for thisComponent in trial_egComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    trials_eg.addData('blankScreen_2.started', blankScreen_2.tStartRefresh)
    trials_eg.addData('blankScreen_2.stopped', blankScreen_2.tStopRefresh)
    trials_eg.addData('call1_2.started', call1_2.tStartRefresh)
    trials_eg.addData('call1_2.stopped', call1_2.tStopRefresh)
    trials_eg.addData('call2_2.started', call2_2.tStartRefresh)
    trials_eg.addData('call2_2.stopped', call2_2.tStopRefresh)
    trials_eg.addData('call3_2.started', call3_2.tStartRefresh)
    trials_eg.addData('call3_2.stopped', call3_2.tStopRefresh)
    trials_eg.addData('call4_2.started', call4_2.tStartRefresh)
    trials_eg.addData('call4_2.stopped', call4_2.tStopRefresh)
    trials_eg.addData('colour1_2.started', colour1_2.tStartRefresh)
    trials_eg.addData('colour1_2.stopped', colour1_2.tStopRefresh)
    trials_eg.addData('colour2_2.started', colour2_2.tStartRefresh)
    trials_eg.addData('colour2_2.stopped', colour2_2.tStopRefresh)
    trials_eg.addData('colour3_2.started', colour3_2.tStartRefresh)
    trials_eg.addData('colour3_2.stopped', colour3_2.tStopRefresh)
    trials_eg.addData('colour4_2.started', colour4_2.tStartRefresh)
    trials_eg.addData('colour4_2.stopped', colour4_2.tStopRefresh)
    trials_eg.addData('number1_2.started', number1_2.tStartRefresh)
    trials_eg.addData('number1_2.stopped', number1_2.tStopRefresh)
    trials_eg.addData('number2_2.started', number2_2.tStartRefresh)
    trials_eg.addData('number2_2.stopped', number2_2.tStopRefresh)
    trials_eg.addData('number3_2.started', number3_2.tStartRefresh)
    trials_eg.addData('number3_2.stopped', number3_2.tStopRefresh)
    trials_eg.addData('number4_2.started', number4_2.tStartRefresh)
    trials_eg.addData('number4_2.stopped', number4_2.tStopRefresh)
    ...
    trials_eg.addData('mouseClickOnCall_2.started', mouseClickOnCall_2.tStart)
    trials_eg.addData('mouseClickOnCall_2.stopped', mouseClickOnCall_2.tStop)
    # store data for trials_eg (TrialHandler)
    ...
    trials_eg.addData('mouseClickOnColour_2.started', mouseClickOnColour_2.tStart)
    trials_eg.addData('mouseClickOnColour_2.stopped', mouseClickOnColour_2.tStop)
    # store data for trials_eg (TrialHandler)
    ...
    trials_eg.addData('mouseClickOnNumber_2.started', mouseClickOnNumber_2.tStart)
    trials_eg.addData('mouseClickOnNumber_2.stopped', mouseClickOnNumber_2.tStop)
    ...
    #logging.flush()
    trials_eg.addData('blankScreenAfterResponse_2.started', blankScreenAfterResponse_2.tStartRefresh)
    trials_eg.addData('blankScreenAfterResponse_2.stopped', blankScreenAfterResponse_2.tStopRefresh)
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
instrTaskClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1
...
while continueRoutine:
    ...
    tThisFlip = win.getFutureFlipTime(clock=instrTaskClock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
    ...
    if pp_instrTask.status == STARTED:
        ...
        if tThisFlipGlobal > pp_instrTask.tStartRefresh + 0.01-frameTolerance:
            ...
            win.timeOnFlip(pp_instrTask, 'tStopRefresh')  # time at next scr refresh
...
for thisComponent in instrTaskComponents:
    if hasattr(thisComponent, "setAutoDraw"):
        thisComponent.setAutoDraw(False)
thisExp.addData('instrTaskText.started', instrTaskText.tStartRefresh)
thisExp.addData('instrTaskText.stopped', instrTaskText.tStopRefresh)
if pp_instrTask.status == STARTED:
    win.callOnFlip(pp_instrTask.setData, int(0))
thisExp.addData('pp_instrTask.started', pp_instrTask.tStartRefresh)
thisExp.addData('pp_instrTask.stopped', pp_instrTask.tStopRefresh)
...
for thisBlock in blocks:
    ...
    while continueRoutine:
        ...
        if pp_blockstart.status == STARTED:
            ...
            if tThisFlipGlobal > pp_blockstart.tStartRefresh + 0.01-frameTolerance:
                ...
                win.timeOnFlip(pp_blockstart, 'tStopRefresh')  # time at next scr refresh
    ...
    if pp_blockstart.status == STARTED:
        win.callOnFlip(pp_blockstart.setData, int(0))
    blocks.addData('pp_blockstart.started', pp_blockstart.tStartRefresh)
    blocks.addData('pp_blockstart.stopped', pp_blockstart.tStopRefresh)
    ...
    for thisTrial in trials:
        ...
        while continueRoutine:
            ...
            if pp_respGrid.status == STARTED:
                ...
                if tThisFlipGlobal > pp_respGrid.tStartRefresh + 0.01-frameTolerance:
                    ...
                    win.timeOnFlip(pp_respGrid, 'tStopRefresh')  # time at next scr refresh
        ...
        if pp_respGrid.status == STARTED:
            win.callOnFlip(pp_respGrid.setData, int(0))
        trials.addData('pp_respGrid.started', pp_respGrid.tStartRefresh)
        trials.addData('pp_respGrid.stopped', pp_respGrid.tStopRefresh)
    ...
    while continueRoutine:
        ...
        if blockEnds.status == STARTED:
            ...
            if tThisFlipGlobal > blockEnds.tStartRefresh + 1-frameTolerance:
                ...
                win.timeOnFlip(blockEnds, 'tStopRefresh')  # time at next scr refresh
        ...
        if pp_blockends.status == STARTED:
            ...
            if tThisFlipGlobal > pp_blockends.tStartRefresh + 0.01-frameTolerance:
                ...
                win.timeOnFlip(pp_blockends, 'tStopRefresh')  # time at next scr refresh
    ...
    for thisComponent in endBlockComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    blocks.addData('blockEnds.started', blockEnds.tStartRefresh)
    blocks.addData('blockEnds.stopped', blockEnds.tStopRefresh)
    if pp_blockends.status == STARTED:
        win.callOnFlip(pp_blockends.setData, int(0))
    blocks.addData('pp_blockends.started', pp_blockends.tStartRefresh)
    blocks.addData('pp_blockends.stopped', pp_blockends.tStopRefresh)
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
instrRest_POSTClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1

# -------Run Routine "instrRest_POST"-------
while continueRoutine:
    # get current time
    t = instrRest_POSTClock.getTime()
    tThisFlip = win.getFutureFlipTime(clock=instrRest_POSTClock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
    ...
    if pp_rest_post.status == STARTED:
        ...
        if tThisFlipGlobal > pp_rest_post.tStartRefresh + 0.01-frameTolerance:
            ...
            win.timeOnFlip(pp_rest_post, 'tStopRefresh')  # time at next scr refresh
...
for thisComponent in instrRest_POSTComponents:
    if hasattr(thisComponent, "setAutoDraw"):
        thisComponent.setAutoDraw(False)
thisExp.addData('instrRest_post.started', instrRest_post.tStartRefresh)
thisExp.addData('instrRest_post.stopped', instrRest_post.tStopRefresh)
if pp_rest_post.status == STARTED:
    win.callOnFlip(pp_rest_post.setData, int(0))
thisExp.addData('pp_rest_post.started', pp_rest_post.tStartRefresh)
thisExp.addData('pp_rest_post.stopped', pp_rest_post.tStopRefresh)
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
restTrial_postClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1

# -------Run Routine "restTrial_post"-------
while continueRoutine:
    # get current time
    t = restTrial_postClock.getTime()
    tThisFlip = win.getFutureFlipTime(clock=restTrial_postClock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
    ...
    if screenAfterAudio_4.status == STARTED:
        ...
        if tThisFlip > 2-frameTolerance:
            ...
            win.timeOnFlip(screenAfterAudio_4, 'tStopRefresh')  # time at next scr refresh
    ...
    if pp_rest_pre_start_2.status == STARTED:
        ...
        if tThisFlipGlobal > pp_rest_pre_start_2.tStartRefresh + 0.01-frameTolerance:
            ...
            win.timeOnFlip(pp_rest_pre_start_2, 'tStopRefresh')  # time at next scr refresh
...
thisExp.addData('screenAfterAudio_4.started', screenAfterAudio_4.tStartRefresh)
thisExp.addData('screenAfterAudio_4.stopped', screenAfterAudio_4.tStopRefresh)
beep_rest_post_end.stop()  # ensure sound has stopped at end of routine
thisExp.addData('beep_rest_post_end.started', beep_rest_post_end.tStartRefresh)
thisExp.addData('beep_rest_post_end.stopped', beep_rest_post_end.tStopRefresh)
if pp_rest_pre_start_2.status == STARTED:
    win.callOnFlip(pp_rest_pre_start_2.setData, int(0))
thisExp.addData('pp_rest_pre_start_2.started', pp_rest_pre_start_2.tStartRefresh)
thisExp.addData('pp_rest_pre_start_2.stopped', pp_rest_pre_start_2.tStopRefresh)
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
thanks_endClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1

# -------Run Routine "thanks_end"-------
while continueRoutine:
    # get current time
    t = thanks_endClock.getTime()
    tThisFlip = win.getFutureFlipTime(clock=thanks_endClock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
...
for thisComponent in thanks_endComponents:
    if hasattr(thisComponent, "setAutoDraw"):
        thisComponent.setAutoDraw(False)
thisExp.addData('thanksText_end.started', thanksText_end.tStartRefresh)
thisExp.addData('thanksText_end.stopped', thanksText_end.tStopRefresh)
