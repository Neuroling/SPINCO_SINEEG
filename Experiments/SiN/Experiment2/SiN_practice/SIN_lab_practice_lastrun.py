...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='Z:\\Projects\\Spinco\\SINEEG\\Scripts\\Experiments\\SiN\\Experiment2\\SiN_practice\\SIN_lab_practice_lastrun.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    instrStartComponents = [instr_start_1, key_resp_inst_4]
    ...
    win.mouseVisible = False 
    # keep track of which components have finished
    instrMain_2Components = [instr_start_2, key_resp_inst_3]
    ...
    while continueRoutine:
        ...
        if instr_start_2.status == NOT_STARTED and tThisFlip >= 0-frameTolerance:
            # keep track of start time/frame for later
