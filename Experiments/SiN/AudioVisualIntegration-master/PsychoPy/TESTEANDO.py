...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='V:\\gfraga\\scripts_neulin\\Projects\\SINEEG\\Experiments\\SiN\\AudioVisualIntegration-master\\PsychoPy\\TESTEANDO.py',
...
for thisTraining in training:
    ...
    while continueRoutine:
        ...
        # *blankScreen* updates
        if blankScreen.status == NOT_STARTED and frameN >= 1:
            # keep track of start time/frame for later
