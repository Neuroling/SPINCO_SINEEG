...
expInfo = {'participant': 'Practice', 'order': '1'}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='Z:\\Projects\\Spinco\\SINEEG\\Scripts\\Experiments\\SiN\\PsychoPy_LAB_Practice\\SIN_lab_practice_lastrun.py',
