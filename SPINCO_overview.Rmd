...
[<database>SPINCO]->online[SINON]
  ...
  [SINEEG]-->Matlab[Noise generation | noise vocoding | speech-shaped noise]
  
  [Noise generation] --> [Lexical Decision]
  [Real-time EEG] --> [Lexical Decision]

  [SINON]-->Rmd [stimuli database | audio recordings] 
  [stimuli database] --> [SINEEG] 
  [Real-time EEG] --> [Lexical Decision]
