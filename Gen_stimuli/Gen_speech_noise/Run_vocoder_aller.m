...
diroutput =  [baseDir,fullfile('Stimuli','AudioGens','Experiment2', 'tts-golang-44100hz',['tts-golang-equalisedDuration-NV'])];
...
for i = 1:length(signals)     
   ...
   for ii = 1:length(target_proportions)       
       ...
       rng(3) % set up random seed, vocoder output should be identical if repeated
