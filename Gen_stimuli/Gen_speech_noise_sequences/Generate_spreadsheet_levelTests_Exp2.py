...
degradation_levels = ['0p','0.05p','0.1p','0.15p']
...
dirs2search = [os.path.join(thisScriptDir[:scripts_index] + 'Stimuli', 'AudioGens','tts-golang-44100hz','tts-golang-selected-NV_Experiment2')]
...
for countdir, dirinput in enumerate(dirs2search):     
    ...
    fullTab2save['block'] = 'none'
    fullTab2save.block[(fullTab2save['noise']=='NV') & (fullTab2save['newidx'].between(0, 3, inclusive='both'))] = 'NV1'
    fullTab2save.block[(fullTab2save['noise']=='NV') & (fullTab2save['newidx'].between(4, 7, inclusive='both'))] = 'NV2'
    fullTab2save.block[(fullTab2save['noise']=='NV') & (fullTab2save['newidx'].between(8, 11, inclusive='both'))] = 'NV3'
    fullTab2save.block[(fullTab2save['noise']=='NV') & (fullTab2save['newidx'].between(12, 15, inclusive='both'))] = 'NV4'
    fullTab2save.block[(fullTab2save['noise']=='NV') & (fullTab2save['newidx'].between(16, 19, inclusive='both'))] = 'NV5'
    fullTab2save.block[(fullTab2save['noise']=='NV') & (fullTab2save['newidx'].between(20, 23, inclusive='both'))] = 'NV6'
    fullTab2save.block[(fullTab2save['noise']=='NV') & (fullTab2save['newidx'].between(24, 27, inclusive='both'))] = 'NV7'
    fullTab2save.block[(fullTab2save['noise']=='NV') & (fullTab2save['newidx'].between(28, 31, inclusive='both'))] = 'NV8'
    fullTab2save = fullTab2save.groupby('block').sample(frac=1)
    
    # Discard excess trials
    fullTab2save = fullTab2save[fullTab2save['block']!= 'none'];
