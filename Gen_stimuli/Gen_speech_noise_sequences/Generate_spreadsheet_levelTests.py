...
dirs2search = [basedir + 'Projects/Spinco/SINEEG/Stimuli/AudioGens/tts-golang-44100hz/tts-golang-selected-NV' ,
               basedir + 'Projects/Spinco/SINEEG/Stimuli/AudioGens/tts-golang-44100hz/tts-golang-selected-SiSSN']
 
diroutput = basedir + 'Projects/Spinco/SINEEG/Stimuli/AudioGens/flow_levelTests/'
...
for countdir, dirinput in enumerate(dirs2search):   
    ...
    praatSummaryFile = basedir + 'Projects/Spinco/SINEEG/Stimuli/AudioGens/Word_onsets/MEAN_tts-golang-selected_wordTimes.csv'
    ...
    vals = ['0.3p','0.4p','0.5p','-11db','-9db','-7db']
