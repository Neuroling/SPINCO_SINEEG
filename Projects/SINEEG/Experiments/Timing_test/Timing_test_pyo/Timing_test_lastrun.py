...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='Z:\\gfraga\\scripts_neulin\\Projects\\SINEEG\\Experiments\\Timing_test\\Timing_test_lastrun.py',
...
for thisTrial in trials:
    ...
    while continueRoutine:
        ...
        # *pp_start_2* updates
        if pp_start_2.status == NOT_STARTED and tThisFlip >= pp_start_time/1000 + 0.08-frameTolerance:
            # keep track of start time/frame for later
