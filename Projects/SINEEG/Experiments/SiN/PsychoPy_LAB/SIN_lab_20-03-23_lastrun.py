...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='V:\\gfraga\\scripts_neulin\\Projects\\SINEEG\\Experiments\\SiN\\PsychoPy_LAB\\SIN_lab_20-03-23_lastrun.py',
...
conditions = data.importConditions('chooseBlocks.csv')
blocks = data.MultiStairHandler(stairType='simple', name='blocks',
    nTrials=1.0,
...
level = blocks._nextIntensity  # initialise some vals
condition = blocks.currentStaircase.condition

for level, condition in blocks:
    currentLoop = blocks
    ...
    for thisTrial in trials:
        ...
        win.mouseVisible = False 
        # keep track of which components have finished
        audioTrialComponents = [sound_1, fixation, screenAfterAudio, pp_t1_start, pp_t1_end, pp_start]
