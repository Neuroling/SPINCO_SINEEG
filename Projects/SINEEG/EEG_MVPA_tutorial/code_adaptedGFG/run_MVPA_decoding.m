...
addpath(scriptPath)
addpath('/home/d.uzh.ch/gfraga/libsvm-3.25/')
addpath('/home/d.uzh.ch/gfraga/libsvm-3.25/tools/')
addpath('/home/d.uzh.ch/gfraga/libsvm-3.25/matlab/')

%% Parameters
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Data path and file
if ispc; basePath = 'V:/gfraga/';else; basePath = '~/smbmount/';end


scriptPath = [basePath,'gfraga/scripts_neulin/Projects/SINEEG/EEG_MVPA_tutorial_master/code_adaptedGFG'];
DataPath      =  [basePath 'spinco_data/SINEEG/analysis/mvpa/data_examples']; 
diroutput = [basePath 'spinco_data/SINEEG/analysis/mvpa/'];
ToolboxesPath = [basePath 'gfraga/scripts_neulin/Projects/SINEEG/EEG_MVPA_tutorial_master/libsvm-3.25'];   % See README for complete description of additional toolboxes that could not be shared. Change this path to the folder containing dependencies
