function [wave,varargout]=fun_vocode(exc, mapping, filters, EnvelopeExtractor, smooth, nCh, x, Srate, MinFreq, MaxFreq, varargin)
%  Adapted by G.FG (mostly comments and clarifications) 
...
x=mean(x,2); %Make signal average of both channels if stereo
nSmp=length(x);
